...
const Footer = () => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            Innovating the future with cutting-edge IT solutions. We specialize in software development, cloud computing, AI-driven applications, cybersecurity, and enterprise solutions to empower businesses worldwide.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-5 mb-6">
              {[
               ...
               { text: "Career Opportunities", to: "/" },
               { text: "Corporate Partnerships", to: "/" },
  ...
  <p className="text-gray-600">
    ...
    <Link to="tel:+91 9021190242" className="hover:text-gray-900">
    +91  9021190242
    </Link>
    
    <br />
    <span className="text-sm text-gray-500">(9:AM to 8:PM IST)</span>
  </p>
  <p className="text-gray-600">
    <span className="text-gray-900">Email:</span>{" "}
    <Link to="mailto:mazedakhale@gmail.com" className="hover:text-gray-900">
    renunciant@gmail.com
    </Link>
  </p>
</div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-600 text-sm"> All Right Reserved  © Renunciant.in  </p>
