...
Platform
 ). Please note that you may be able to 
...
please do not use or access our Platform.
        ...
        <section>
          <h2 className="text-2xl font-semibold text-gray-800">Collection of Personal Data</h2>
          <p className="mt-2 text-lg text-gray-700">
...
any information. If you receive an email, a call from a person/association claiming to be  mazedakhale
...
immediately to an appropriate law enforcement agency.
        ...
        <section>
          <h2 className="text-2xl font-semibold text-gray-800">Usage of Data</h2>
          <p className="mt-2 text-lg text-gray-700">
...
and password records for their account
        ...
        <section>
          <h2 className="text-2xl font-semibold text-gray-800">User Rights</h2>
          <p className="mt-2 text-lg text-gray-700">
...
continue to retain your data in anonymised form for analytical and research purposes.
        ...
        <section>
          <h2 className="text-2xl font-semibold text-gray-800">Consent</h2>
          <p className="mt-2 text-lg text-gray-700">
...
services for which we consider such information to be necessary.
        ...
        <section>
          <h2 className="text-2xl font-semibold text-gray-800">Changes to Policy</h2>
          <p className="mt-2 text-lg text-gray-700">
...
laws
        ...
        <section>
          ...
          <p className="mt-2 text-lg text-gray-700">
            If you have any questions, contact us at <strong>support@mazedakhale.in</strong>.
          </p>
        </section>
      </div>
...
export default PrivacyPolicyPhonepay;
